          ...
          <section className="py-20 px-4 bg-[hsl(225_97%_4%)]">
            <div className="max-w-5xl mx-auto">
              ...
              <div className="space-y-6">
                {[
                  { title: "Rapid Dispatch", description: "Our logistics coordinators are available around the clock to take your expedited orders. We maintain a network of cargo van and sprinter van operators positioned across the 48 contiguous states, enabling pickup within hours of your call." },
