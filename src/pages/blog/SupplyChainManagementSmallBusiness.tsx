...
const SupplyChainManagementSmallBusiness = () => {
  ...
  const content = (
    <>
      ...
      <p>
        Freight supply chain management breaks down into five core areas. Each one affects your bottom line differently, and each one has specific tactics that work at the small business scale.
      </p>

      <h3>Transportation and Carrier Selection</h3>
      <p>
        Transportation is where most of your logistics budget goes. For small businesses, the biggest wins come from matching the right mode to each shipment. A 6-pallet order doesn't need a full truckload. Shipping it LTL can save 30-40% compared to booking an entire 53-foot trailer. But if you're regularly shipping 8 or more pallets to the same destination, consolidating into a <Link to="/services/ftl">full truckload</Link> eliminates the handling damage and transit delays that come with LTL terminals. Understanding when to use <Link to="/blog/ltl-vs-ftl-freight-shipping">LTL versus FTL</Link> is one of the simplest ways to cut freight spend without changing anything else about your operation.
      </p>
      <p>
        But carrier selection matters beyond price. A carrier that's $200 cheaper per load but delivers late 15% of the time costs you more in customer complaints, rescheduled dock appointments, and production delays. Track on-time delivery percentage, claims ratio, and average transit time for every carrier you use. After three months, you'll have enough data to know which carriers earn your freight and which ones need to be replaced.
      </p>

      <h3>Warehousing and Distribution</h3>
      <p>
        Most small businesses outgrow their warehouse capacity before they can afford to lease a larger facility. Seasonal demand makes this worse. You might need 8,000 square feet of storage from September through December but only 3,000 the rest of the year. Paying year-round rent on space you use four months out of twelve drains cash that could go toward growth. Shared warehousing through a <Link to="/services/3pl">3PL provider</Link> lets you scale storage up and down based on actual demand, paying only for the space and handling you use each month.
      </p>
      <p>
        Distribution network design also affects your freight costs. If all your inventory sits in one location on the West Coast but 60% of your customers are east of the Mississippi, every shipment crosses multiple zones. Splitting inventory across two or three warehouse locations can cut average transit times by 1-2 days and reduce per-shipment transportation costs by 15-25%. A 3PL with a national warehouse network makes this possible without requiring you to sign multiple leases or hire staff in each location.
      </p>
      ...
      <p>
        Your supply chain starts with your suppliers. If they ship late, your entire downstream schedule shifts. Small businesses often accept whatever lead time a supplier quotes without pushing back. And yet lead times are negotiable, especially if you can offer consistent order volumes or longer-term purchase commitments. Reducing supplier lead time by even 3-5 days gives you more flexibility to respond to customer orders without holding excess inventory.
      </p>
      <p>
      ...
      <p>
        You don't need a consultant or a six-month planning process to build a functional supply chain strategy. Start here and refine as you go.
      </p>

      <h3>Step 1: Map Your Current Freight Spend</h3>
      <p>
        Pull every freight invoice from the last 6-12 months. Categorize each shipment by lane, mode, carrier, and total cost including accessorials. Most small businesses are surprised by what they find: different rates for the same lane depending on which employee booked the load, accessorial charges like liftgate or residential delivery fees that could've been avoided with better planning, and a concentration of spend on one or two carriers with no backup options.
      </p>

      <h3>Step 2: Identify Your Top 5 Lanes</h3>
      <p>
        Focus first on your top five lanes by volume or spend. For each one, document the current rate, transit time, on-time percentage, and claims history. That baseline tells you exactly where improvement is possible, and it gives you leverage when you sit down to negotiate with carriers.
      </p>

      <h3>Step 3: Evaluate Mode Selection</h3>
      <p>
        Shipments between 5,000 and 10,000 pounds sit in the gray zone where <Link to="/services/ltl">LTL</Link> and <Link to="/services/ftl">FTL</Link> pricing overlap. Run the numbers both ways for each of your top lanes. Factor in not just the line-haul rate but also pickup and delivery charges, fuel surcharges, and the cost of potential damage from additional handling in the LTL network.
      </p>

      <h3>Step 4: Build Carrier Redundancy</h3>
      <p>
        Don't rely on a single carrier for any lane. Get rate quotes from at least two carriers per lane. Even if you route 80% of volume to your primary, having a qualified backup prevents the desperation pricing that comes from last-minute capacity searches.
      </p>

      <h3>Step 5: Set Up Tracking and KPIs</h3>
      <p>
        Track three metrics from day one: cost per shipment by lane, on-time delivery percentage by carrier, and claims ratio. Review them monthly. After 90 days, you'll have enough data to make informed decisions about carrier allocation, mode selection, and where to invest in warehouse positioning.
      </p>
      ...
      <p>
        If you're spending more than two hours per week managing freight, or if your monthly shipping spend exceeds $5,000, the math favors working with a dedicated freight partner. The time you spend calling carriers, tracking shipments, and resolving delivery issues has a real cost. For a business owner, spending 10 hours per month on logistics is 10 hours not spent on sales, product development, or customer relationships -- and that's before counting the rate disadvantage of booking freight independently.
      </p>
      <p>
        DeMar Transportation works with small businesses across the 48 contiguous states to build freight programs that scale with growth. From 5 loads per month to 50, our team handles carrier selection, rate negotiation, shipment tracking, and claims management. You get the same supply chain management capabilities that large shippers build internally, without the overhead of a dedicated logistics department.
      </p>
      <p>
        The first step is understanding where your current supply chain stands. Request a freight analysis from our team, and we'll review your shipping data, identify cost reduction opportunities, and build a carrier strategy for your highest-volume lanes. There's no cost for the analysis, and you'll walk away with actionable data regardless of whether you choose to work with us.
      </p>
    </>
  );
