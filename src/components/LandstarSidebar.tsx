      ...
      <div className="p-4">
        ...
        <div className="space-y-2">
          {menuSections.map((section) => (
            <Card key={section.id} className="bg-primary-foreground/5 border-primary-foreground/10">
                ...
                {expandedSections.includes(section.id) && (
                  <div className="px-4 pb-4 space-y-2 animate-fade-in">
                    {section.items.map((item, index) => (
                      <div
                        key={index}
                        className="p-3 rounded-md bg-primary-foreground/5 hover:bg-primary-foreground/10 cursor-pointer transition-colors group"
                      >
