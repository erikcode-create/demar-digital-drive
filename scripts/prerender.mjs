...
const routes = [
  ...
  '/locations',
  '/locations/reno-freight-shipping',
  '/locations/nevada-ltl-freight',
  '/locations/nevada-reefer-freight',
  '/locations/reno-warehouse-distribution',
  '/resources',
  ...
  '/blog/ltl-freight-shipping-nevada',
