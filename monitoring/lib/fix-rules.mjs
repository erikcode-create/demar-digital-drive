...
const FIX_RULES = [
  ...
  // --- Tier 2: Auto-PR (needs human review) ---
  {
    ...
    prompt: (check) => `The JSON-LD schema in index.html is missing required properties: ${check.detail}. Add the missing properties with appropriate values for DeMar Transportation (freight carrier, Reno, NV, (775) 230-4767). Then run \`npm run build\` and confirm it succeeds.`,
